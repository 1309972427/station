...
PLAYM4_API BOOL __stdcall PlayM4_SetDisplayRegionOnWnd(LONG nPort,DWORD nRegionNum, RECT *pSrcRect, BOOL bEnable);///<多窗口分割接口
...
typedef enum tagFECCorrectType
{
    ...
    FEC_CORRECT_LAT        = 0x400,        // 纬度展开矫正
    FEC_CORRECT_SEMISPHERE = 0x500,        // 半球(球面)矫正-（硬解不支持-可以开多路）
